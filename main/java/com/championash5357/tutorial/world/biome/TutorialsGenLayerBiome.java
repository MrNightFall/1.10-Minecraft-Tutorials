...
public class TutorialsGenLayerBiome extends GenLayer
{
    @SuppressWarnings("unchecked")
    private java.util.List<net.minecraftforge.common.BiomeManager.BiomeEntry>[] biomes = new java.util.ArrayList[net.minecraftforge.common.BiomeManager.BiomeType.values().length];
    private final ChunkProviderSettings settings;

    public TutorialsGenLayerBiome(long p_i45560_1_, GenLayer p_i45560_3_, WorldType p_i45560_4_, String p_i45560_5_)
    {
        super(p_i45560_1_);
        ...
        biomes[desertIdx].add(new net.minecraftforge.common.BiomeManager.BiomeEntry(TutorialBiomeRegistry.tutorial, 10));
