...
public class TutorialWorldBorder
{
    private final List<TutorialBorderListener> listeners = Lists.<TutorialBorderListener>newArrayList();
    private double centerX;
    private double centerZ;
    private double startDiameter = 12.0E7D;
    ...
    public TutorialWorldBorder()
    {
        this.endDiameter = this.startDiameter;
        this.worldSize = 59999984;
    ...
    public void setCenter(double x, double z)
    {
        ...
        for (TutorialBorderListener iborderlistener : this.getListeners())
        {
    ...
    protected List<TutorialBorderListener> getListeners()
    {
        return Lists.newArrayList(this.listeners);
    }

    public void addListener(TutorialBorderListener listener)
    {
