...
public class BlockTutorialPortal extends BlockBreakable {
    ...
    {
        BlockTutorialPortal.Size blockportal$size = new BlockTutorialPortal.Size(worldIn, pos, EnumFacing.Axis.X);
        ...
        {
            BlockTutorialPortal.Size blockportal$size1 = new BlockTutorialPortal.Size(worldIn, pos, EnumFacing.Axis.Z);
	...
	public void onEntityCollidedWithBlock(World worldIn, BlockPos pos, IBlockState state, Entity entityIn)
    {
        if (!entityIn.isRiding() && !entityIn.isBeingRidden() && entityIn.isNonBoss() && entityIn instanceof EntityPlayerMP)
        {
            ...
            if(thePlayer.timeUntilPortal > 0) {
            ...
            } else if (thePlayer.dimension != TutorialDimensionRegistry.tutorialDimensionID) {
            	thePlayer.timeUntilPortal = 10;
            	...
            	thePlayer.timeUntilPortal = 10;
				thePlayer.mcServer.getPlayerList().transferPlayerToDimension(thePlayer, 0, new TutorialTeleporter(thePlayer.mcServer.worldServerForDimension(0)));
            }
        }
    }
	...
	public static class Size
    {
        ...
        protected int getDistanceUntilEdge(BlockPos p_180120_1_, EnumFacing p_180120_2_)
        {
            ...
            for (i = 0; i < 22; ++i)
            {
                ...
                if (!this.isEmptyBlock(this.world.getBlockState(blockpos).getBlock()) || this.world.getBlockState(blockpos.down()).getBlock() != TutorialBlocks.purple_glowstone)
                {
                    break;
                }
            }
            ...
            return block == TutorialBlocks.purple_glowstone ? i : 0;
        }
        ...
        protected int calculatePortalHeight()
        {
            ...
            for (this.height = 0; this.height < 21; ++this.height)
            {
                for (int i = 0; i < this.width; ++i)
                {
                    ...
                    if (block == TutorialBlocks.tutorial_portal_block)
                    {
                    ...
                    if (i == 0)
                    {
                        ...
                        if (block != TutorialBlocks.purple_glowstone)
                        {
                            break label24;
                        }
                    }
            ...
            {
                if (this.world.getBlockState(this.bottomLeft.offset(this.rightDir, j).up(this.height)).getBlock() != TutorialBlocks.purple_glowstone)
                {
                    this.height = 0;
                    break;
                }
        ...
        {
            return blockIn.getMaterial(blockIn.getDefaultState()) == Material.AIR || blockIn == Blocks.FIRE || blockIn == TutorialBlocks.tutorial_portal_block;
        }
        ...
        public void placePortalBlocks()
        {
            for (int i = 0; i < this.width; ++i)
            {
                ...
                {
                    this.world.setBlockState(blockpos.up(j), TutorialBlocks.tutorial_portal_block.getDefaultState().withProperty(BlockPortal.AXIS, this.axis), 2);
                }
            }
        }
    }
	...
	public BlockPattern.PatternHelper createPatternHelper(World worldIn, BlockPos p_181089_2_)
    {
        ...
        BlockTutorialPortal.Size blockportal$size = new BlockTutorialPortal.Size(worldIn, p_181089_2_, EnumFacing.Axis.X);
        LoadingCache<BlockPos, BlockWorldState> loadingcache = BlockPattern.createLoadingCache(worldIn, true);

        if (!blockportal$size.isValid())
        {
            enumfacing$axis = EnumFacing.Axis.X;
            blockportal$size = new BlockTutorialPortal.Size(worldIn, p_181089_2_, EnumFacing.Axis.Z);
        }
