...
public class ItemBlockColoredGlowstoneSlab extends ItemBlock{
	
	private final BlockSlab singleSlab;
    private final BlockSlab doubleSlab;
	
	public ItemBlockColoredGlowstoneSlab(Block block, BlockSlab singleSlab, BlockSlab doubleSlab) {
		super(block);
